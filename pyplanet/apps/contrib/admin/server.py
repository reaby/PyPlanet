	...
	async def on_start(self):
		...
		await self.instance.command_manager.register(
			...
			Command(command='modesettings', target=self.mode_settings, perms='admin:mode', admin=True,
					description='Displays and allows for updating of the gamemode settings.').add_param(name='setting', required=False)
			...
			Command(command='server', target=self.server_settings, perms='admin:mode', admin=True),
		)
