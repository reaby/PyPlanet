...
class ToolbarAdmin:
    ...
    async def on_start(self):
        ...
        # Register commands.
        await self.instance.permission_manager.register('toolbar', 'Toggle the admin toolbar', app=self.app,
                                                        min_level=1)
        await self.instance.command_manager.register(
            Command(command='toolbar', perms='admin:toolbar', target=self.toggle_toolbar, admin=True,
                    description='Toggles the admin toolbar.')
        )
